...
public class HandleExceptionServiceTaskHandler implements WorkItemHandler {
    ...
    public static final String FAILURE_SERVICE = "org.jbpm.more.failure.service";
    public static final String FAILURE_OPERATION = "org.jbpm.more.failure.operation";
    public static final String FAILURE_PARAMETER_TYPE = "org.jbpm.more.failure.parameter.type";

    public static final String FAILURE_EXCEPTION = "org.jbpm.more.failure.exception";
    public static final String FAILURE_REASON = "org.jbpm.more.failure.reason";
    public static final String FAILURE_TRACE = "org.jbpm.more.failure.trace";
